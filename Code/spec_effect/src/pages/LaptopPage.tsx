                    ...
                    <div className="App-colBox" style={{width: "80vw", overflowX: "auto"}} data-testid="laptop-items">
                        <div className="App-row">
                            ...
                            <div className="App-colBox">
                                ...
                                <ul style={{listStyleType: "none", marginLeft: "4vw", textAlign: "left", lineHeight: "30px"}}>
                                    <li> <b>CPU Type:</b> {laptop.cpuName}</li>
                                    <li> <b>Cores:</b> {laptop.cpuCoreCount}</li>
                                    <li> <b>Memory/RAM Size:</b> {laptop.memoryGb} GB</li>
                                    <li> <b>GPU Type:</b> {laptop.gpuName || "N/A"}</li>
                                    <li> <b>GPU VRAM Size:</b> {laptop.gpuVramMb} MB</li>
                                    <li> <b>Disk Storage Type:</b> <span style={{ textTransform: 'uppercase' }}>{laptop.storageType}</span></li>
                                    <li> <b>Storage Size:</b> {laptop.storageCapacityGb} GB</li>
                                    <li> <b>Estimated Price:</b> ${laptop.priceCents/100}</li>
                                </ul>
