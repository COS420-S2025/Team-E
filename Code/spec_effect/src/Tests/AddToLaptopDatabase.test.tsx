...
describe("AddToLaptopDatabase", () => {
    test("renders the Add to Laptop Database heading", () => {
        ...
        expect(screen.getByRole("heading", { name: /Add to Laptop Database/i })).toBeInTheDocument();
    });
    ...
    test("renders all required input fields", () => {
        ...
        expect(screen.getByLabelText(/Storage Capacity \(GB\)/i)).toBeInTheDocument();
    ...
    test("renders the Add Laptop button", () => {
        ...
        expect(screen.getByRole("button", { name: /Add Laptop/i })).toBeInTheDocument();
    });
});
